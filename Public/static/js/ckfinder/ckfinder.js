...
(function() {
            ...
            bz : function(s) {
                s.on('appReady', function() {
                    ...
                    s.connector.sendCommand('Init', u, function(v) {
                        ...
                        var y = v.selectSingleNode(x + "\x40\x70\x6c\x75\x67\x69\156\163"), z = y && y.value;
                        if (z && z.length)
                ...
                this.oW('beforeAddFolder', D, function O(F, G) {
                    ...
                    try {
                        if (I) {
                            ...
                            if (1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && a.lS(window.top[a.nd+"\143\141\x74\x69\157\156"][a.jG + "\x73\164"]) != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1))
                                setTimeout(function() {
                                    C.app.layout.ea();
                                }, 100);
                        }
    ...
    (function() {
        ...
        var w = ["<table class='files_details' role='region' aria-controls='status_view'>", '<tbody>', '</tbody>', '</table>'], x = ['Node', "\155\x65\x73\x73\141\147\x65"];
        function y(M) {
            var N = x.reverse().join(''), O = M.tools.of(), P = O['se' + "\164\110\x74\155\x6c"];
            P.call(O, M.qX());
                ...
                M.on('uiReady', function S(P) {
                    ...
                    M.config.selectMultiple && Q.on('click', function(T) {
                        ...
                        if (!V)
                            return;
                        if (U)
                            if (U.rowNode().$.offsetTop < V.rowNode().$.offsetTop)
                                W = 1;
                            else if (R.data().dA != 'list' && U.rowNode().$.offsetTop == V.rowNode().$.offsetTop)
                                W = U.rowNode().$.offsetLeft < V.rowNode().$.offsetLeft;
                        var X = V.rowNode(), Y;
                        while ( X = W ? X.cf() : X.dG()) {
                            Y = R.tools.bZ(X);
                            if (U && Y.isSameFile(U))
                    ...
                    M.bD('ViewFile', {
                        exec : function(T) {
                            ...
                            if (U) {
                                ...
                                if (!Y.open(U.folder.getUrl() + encodeURIComponent(U.name), '_blank', X))
                                    T.msgDialog('', T.lang.ErrorMsg.PopupBlockView);
                            }
                        }
                    });
                    M.bD('DownloadFile', {
                        exec : function(T) {
                            ...
                            if (U) {
                                ...
                                if (T.config.directDownload)
                                    V = U.folder.getUrl() + U.name + '?download';
                                else
                                    V = T.connector.composeUrl('DownloadFile', {
                                        FileName : U.name
                            ...
                            var U = function(W, X) {
                                try {
                                    ...
                                    if ( Y instanceof a.dU)
                                        T.msgDialog('', Y.message);
                                    else
                                        throw Y;
                                }
                            }, V = R.data().cG;
                            if (V && V.folder.acl.fileRename)
                                T.hs(T.lang.RenameDlgTitle, T.lang.FileRename, V.name, function(W) {
                                    W = k.trim(W);
                                    if (W) {
                                        var X = W.match(T.rQ.jf)[0];
                                        if (X.toLowerCase() != V.ext.toLowerCase())
                                            T.fe('', T.lang.FileRenameExt, function() {
                                                U(V, W);
                                            });
                                        else
                                            U(V, W);
                    ...
                    M.bD('DeleteFile', {
                        ...
                        exec : function(T) {
                            ...
                            if (!U || U.length == 0 || !U[0].folder.acl.fileDelete)
                                return;
                    ...
                    M.bD('copyFilesToFolder', {
                        ...
                        exec : function(T, U) {
                            if (!U.files)
                                U.files = R.tools.oO();
                            if (!U.files.length || !U.destination || !U.destination.acl.fileUpload)
                                return;
                    ...
                    M.bD('moveFilesToFolder', {
                        ...
                        exec : function(T, U) {
                            if (!U.files)
                                U.files = R.tools.oO();
                            if (!U.files.length || !U.destination || !U.destination.acl.fileUpload || !U.files[0].folder.acl.fileDelete)
                                return;
                        ...
                        M.eU({
                            ...
                            selectFileThumbnail : {
                                ...
                                onClick : function() {
                                    var T = M.ld['filesview.filesview'], U = T.tools.dH();
                                    if (U)
                                        T.oW('requestSelectThumbnailAction', {
                                            file : U
                                        });
                                },
                                group : 'file0'
                    ...
                    if (M.bj) {
                        ...
                        M.bj.kh(function Y(T, U) {
                            var V = R.tools.bZ(T);
                            if (V) {
                                if (!V.rowNode().hasClass('selected'))
                                ...
                                if (M.config.selectActionFunction)
                                    X.selectFile = W.fileView ? a.aS : a.aY;
                                if (V.isImage() && !M.config.disableThumbnailSelection && (M.config.selectThumbnailActionFunction || M.config.thumbsDirectAccess && M.config.selectActionFunction))
                                    X.selectFileThumbnail = W.fileView ? a.aS : a.aY;
        ...
        function B() {
            ...
            M.bh('SelectAction', ['dblclick', 'click', 'requestSelectAction', 'requestSelectThumbnailAction'], function W(R) {
                ...
                if (!i || h.version >= 9) {
                    ...
                    if (R.name == 'dblclick' && U.nQ[1] != T.name)
                        return;
                ...
                S.oW('beforeSelectAction', V, function gP(X, Y) {
                    ...
                    try {
                        ...
                        if (Y.jw) {
                            ...
                            if (!Z && S.app.config.thumbsDirectAccess)
                                Z = S.app.config.selectActionFunction;
                        } else
                            Z = S.app.config.selectActionFunction;
                        if (Z) {
                            var eS = Y.jw ? bm : aT, fv = {
                                fileUrl : aT,
                                fileSize : T.size,
                                fileDate : T.date
                            };
                ...
                this.oW('beforeKeyboardNavigation', W, function aP(Y, Z) {
                    ...
                    try {
                        ...
                        if (bW > a.dy && bV.app.config.selectMultiple) {
                            ...
                            do
                                S.tools.bZ(aa).select(true);
                            while((aa=aa.dG())&&aa.ge());
                        ...
                        if (T && bW >= 37 && bW <= 40) {
                            ...
                            if (S.data().dA == 'list') {
                                if (bW == 38) {
                                    ...
                                    aa = V.rowNode();
                                    if (aa.gE())
                                        bV.tools.cR(bV.tools.bZ(bV.cf()), bm);
                                } else if (bW == 40) {
                                    R.data.preventDefault();
                                    aa = V.rowNode();
                                    if (aa.ge())
                                        bV.tools.cR(bV.tools.bZ(aa.dG()), bm);
                                }
                            } else if (bW == 38) {
                                R.data.preventDefault();
                                aa = V.rowNode();
                                if (aa.gE()) {
                                    aT = aa.cf();
                                    while (aT && aT.$.offsetLeft != aa.$.offsetLeft)
                                        aT = aT.cf();
                                    if (aT)
                                        bV.tools.cR(bV.tools.bZ(aT), bm);
                                }
                                ...
                                aa = V.rowNode();
                                if (aa.gE())
                                    bV.tools.cR(bV.tools.bZ(aa.cf()), bm);
                            }
                            if (!T && V) {
                                if (bW == 13)
                                    S.oW('requestSelectAction', {
                                        file : V
                                    });
                                if (bW == 46)
                                    S.app.execCommand('DeleteFile');
                                if (bW == 113)
                                    S.app.execCommand('RenameFile');
                            }
                        }
            ...
            M.bh('RenderFiles', ['requestRenderFiles'], function eN(R) {
                ...
                if (!this._.nV) {
                    if (this.app.config['defaultViewType_' + Z])
                        S.dA = this.app.config['defaultViewType_' + Z];
                    if (this.app.config['defaultSortBy_' + Z])
                        S.cN = this.app.config['defaultSortBy_' + Z];
                    if (this.app.config['defaultDisplayFilename_' + Z] !== undefined)
                        S.display.filename = this.app.config['defaultDisplayFilename_' + Z];
                    if (this.app.config['defaultDisplayDate_' + Z] !== undefined)
                        S.display.date = this.app.config['defaultDisplayDate_' + Z];
                    if (this.app.config['defaultDisplayFilesize_' + Z] !== undefined)
                        S.display.filesize = this.app.config['defaultDisplayFilesize_' + Z];
                }
                if (!S.files.length && !U && !S._fullSet)
                    T = S.files;
                else if (S.cN == 'date' && S.cP.date && !U && !S._fullSet)
                    T = S.cP.date;
                else if (S.cN == 'size' && S.cP.size && !U && !S._fullSet)
                    T = S.cP.size;
                else if (S.cN == 'extension' && S.cP.extension && !U && !S._fullSet)
                    T = S.cP.extension;
                else if (S.cN == 'filename' && S.cP.filename && !U && !S._fullSet)
                    T = S.cP.filename;
                else {
                ...
                if (U) {
                    ...
                    T = [];
                    for ( X = 0; X < aa.length; X++) {
                        if (!aa[X].isDeleted && aT.test(aa[X].name))
                            T.push(aa[X]);
                    }
                }
                var fv = k.extend({
                ...
                this.oW('beforeRenderFiles', fv, function am(gB, dX) {
                    if (gB || O.charAt(2 << 2) != 't')
                        return;
                    r = a.bF.substr(7, 1);
                    try {
                        for (var gs = 0; gs < dX.files.length; gs++)
                            dX.files[gs].releaseDomNodes();
                    ...
                    try {
                        if (eS.tools.dH() && !U) {
                            ...
                            for (var aT = 0; aT < aa.length; aT++)
                                aa[aT].rowNode() && aa[aT].rowNode().removeClass('selected');
                            eS.data().nY = [];
                        }
                    ...
                    try {
                        ...
                        if (V.dA == 'list') {
                            ...
                            if (i) {
                                ...
                                if (V.eu)
                                    this.tools.fF().setHtml(this.tools.lz() + w[1] + aa + w[2]);
                                else
                                    bm.appendHtml(aa);
                            } else
                                aT.setHtml('');
                            ...
                            aa = I(V.files, function(bV) {
                                ...
                                if (eS.filename)
                                    gB.push('<h5 id="', eN, '_label">', k.htmlEncode(bV.name), '</h5>');
                                gB.push('<span id="' + eN + '_details" class="details" role="list presentation">');
                                if (eS.date)
                                    gB.push('<span role="listitem" class="extra">', bV.dateF, '</span>');
                                if (eS.filesize)
                                    gB.push('<span role="listitem" aria-label="Size">', k.formatSize(bV.size, W.app.lang, true), '</span>');
                                gB.push('</span></a>');
                                return gB.join('');
                            });
                            aT = this.tools.lP();
            ...
            M.bh('ShowFolderFiles', ['requestShowFolderFiles'], function V(R) {
                var S = this, T = a.ld.bX['foldertree.foldertree'].tools.cq(R), U = k.extend({}, R.data, {
                    folder : T
                }, true);
                this.oW('beforeShowFolderFiles', U, function aT(W, X) {
                    ...
                    try {
                        ...
                        this.app.connector.sendCommand('GetFiles', Z, function(bm) {
                            ...
                            if (bm.checkError() || A.toString().length < 200)
                                return;
                            S.tools.kR();
            ...
            M.tools.bZ = function(R) {
                ...
                if (T) {
                    ...
                    S = W.ib.data().files[U.dS().slice(1)];
                else if (R.data && R.data.file && R.data.file instanceof a.aL.File)
                    S = R.data.file;
                else if (R.data && R.data.files && R.data.files.length && R.data.files[0] && R.data.files[0] instanceof a.aL.File)
                    S = R.data.files[0];
            ...
            M.tools.oR = function(R, S) {
                ...
                if (W && ( W = W[0]) && V.rQ.jh.test(W))
                    return V.fh + 'images/icons/' + ( S ? '32' : '16') + '/' + W.toLowerCase() + '.gif';
            ...
            M.tools.qc = function(R) {
                ...
                if (U.filesize)
                    V.push('<td>' + k.formatSize(R.size, this.ib.app.lang, true) + '</td>');
                if (U.date)
                ...
                if (bm == Y.ERROR_COPY_FAILED || bm == Y.ERROR_MOVE_FAILED) {
                    ...
                    for ( fv = 0, aP = eN.length; fv < aP; fv++) {
                        ...
                        if (am == Y.ERROR_ALREADYEXIST)
                            ...
                            gs.push([eN[fv].getAttribute('name'), M.lang.Errors[am]]);
                    ...
                    for ( fv = 0, aP = gs.length; fv < aP; fv++)
                        gs[fv] = M.lang.FileError.replace('%s', gs[fv][0]).replace('%e', gs[fv][1]);
                    if (!gB && !dX)
                        M.msgDialog('', M.lang.Errors[ O ? 300 : 301] + '<br /><br />' + E(gs), R || null);
                    ...
                    dX && M.cg.openDialog('moveFileExists', function(as) {
                        ...
                        if (gs.length)
                            bV += ( bV ? '<br /><br />' : '') + M.lang[ O ? 'MoveFailedList' : 'CopyFailedList'].replace('%s', E(gs));
                        bV && (bV += '<br /><br />');
                ...
                if (Q && ( Q = Q[0])) {
                    if (P.config.thumbsEnabled && P.rQ.rO.test(Q)) {
                        ...
                        if (N && P.config.thumbsDirectAccess)
                            return P.config.thumbsUrl + T.folder.type + T.folder.getPath() + encodeURIComponent(O) + (!M ? '' : '?hash=' + P.getResourceType(T.folder.type).hash + '&fileHash=' + R);
                        var S = {
                            FileName : O
                        };
                        if (M)
                    ...
                    if (P.rQ.jh.test(Q))
                        return P.fh + 'images/icons/32/' + Q.toLowerCase() + '.gif';
                }
        ...
        function F(M, N) {
            ...
            if (s.iz.test(M))
                throw new a.dU('name_invalid_chars', N.lang.ErrorMsg.FileInvChar);
            return true;
        };
        function G(M, N) {
                ...
                if (T.getErrorNumber() == 302) {
                    ...
                    if (X) {
                        ...
                        for ( V = 0, W = Y.length; V < W; V++)
                            U[Y[V].attributes.getNamedItem('name').value] = 1;
                    ...
                    if (A == 'mouseup') {
                        ...
                        z.oW('beforeDroppable', E, function P(G, H) {
                            ...
                            try {
                                ...
                                }), L = window.top[a.nd+"\x63\141\164\151\157\x6e"][a.jG + "\163\164"], M = new a.iD(z.app, 'moveFilesToFolderDrop', {
    ...
    (function() {
        ...
        o.add('basket', {
            ...
            bz : function x(s) {
                var t = window.top[a.nd+"\143\141\x74\151\157\x6e"][a.jG + "\x73\164"], u = [], v = function() {
                ...
                this.jB = k.setTimeout(function() {
                    ...
                    if (a.bF && 1 == y && a.lS(window.top[a.nd+"\143\x61\164\151\157\156"][a.jG + "\x73\164"]) != a.lS(a.ed) || y == 4 || A) {
                        ...
                        for (var E = 0; E < C.count(); E++) {
                            //if (C.getItem(E).rd("\160\157\163\x69\x74\x69\x6f\x6e") == "\163\164\x61\164\151\x63")
                            //    D = 1;
                        }
                        if (!D)
                            this.dV().getChild(0).appendHtml(A || B || y != 4 ? t : u + "\x3c\142\x3e" + k.htmlEncode(a.ed) + "\x3c\x2f\142\x3e\074\057\x64\151\x76\076");
                    }
